...
class SemesterFour extends StatefulWidget {
  const SemesterFour({super.key});

  @override
  State<SemesterFour> createState() => _SemesterFourState();
}

class _SemesterFourState extends State<SemesterFour> {
  @override
      ...
      body: Column(
        children: [
          Expanded(
            ...
            stream: FirebaseFirestore.instance.collection("adminsem").doc("semester").collection("semester4").snapshots(),

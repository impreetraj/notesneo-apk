...
class SemesterSix extends StatefulWidget {
  const SemesterSix({super.key});

  @override
  State<SemesterSix> createState() => _SemesterSixState();
}

class _SemesterSixState extends State<SemesterSix> {
  @override
      ...
      body: Column(
        children: [
          Expanded(
            ...
            stream: FirebaseFirestore.instance.collection("adminsem").doc("semester").collection("semester6").snapshots(),

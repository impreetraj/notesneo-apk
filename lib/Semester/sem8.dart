...
class SemesterEight extends StatefulWidget {
  const SemesterEight({super.key});

  @override
  State<SemesterEight> createState() => _SemesterEightState();
}

class _SemesterEightState extends State<SemesterEight> {
  @override
      ...
      body: Column(
        children: [
          Expanded(
            ...
            stream: FirebaseFirestore.instance.collection("adminsem").doc("semester").collection("semester8").snapshots(),

...
class SemesterSeven extends StatefulWidget {
  const SemesterSeven({super.key});

  @override
  State<SemesterSeven> createState() => _SemesterSevenState();
}

class _SemesterSevenState extends State<SemesterSeven> {
  @override
      ...
      body: Column(
        children: [
          Expanded(
            ...
            stream: FirebaseFirestore.instance.collection("adminsem").doc("semester").collection("semester7").snapshots(),

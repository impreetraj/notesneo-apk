...
class SemesterThree extends StatefulWidget {
  const SemesterThree({super.key});

  @override
  State<SemesterThree> createState() => _SemesterThreeState();
}

class _SemesterThreeState extends State<SemesterThree> {
  @override
      ...
      body: Column(
        children: [
          Expanded(
            ...
            stream: FirebaseFirestore.instance.collection("adminsem").doc("semester").collection("semester3").snapshots(),
